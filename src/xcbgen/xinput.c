...
{
    return (xcb_input_device_info_t *) (&R->pad0 + 1);
}
...
{
    return (xcb_input_input_class_info_t *) (&R->pad0 + 1);
}
...
{
    return (xcb_input_event_class_t *) (&R->pad0 + 1);
}
...
{
    return (xcb_input_grab_modifier_info_t *) (&R->pad1 + 1);
}
