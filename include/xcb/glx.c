...
{
    return (xcb_glx_float64_t *) (&R->pad1 + 1);
}
...
{
    return (xcb_glx_float64_t *) (&R->pad2 + 1);
}
...
{
    return (xcb_glx_float32_t *) (&R->pad2 + 1);
}
