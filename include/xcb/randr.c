...
{
    return (xcb_randr_screen_size_t *) (&R->pad0 + 1);
}
...
{
    return (xcb_randr_crtc_t *) (&R->pad1 + 1);
}
...
{
    return (xcb_randr_crtc_t *) (&R->name_len + 1);
}
...
{
    return (xcb_randr_output_t *) (&R->num_possible_outputs + 1);
}
...
{
    return (char *) (&R->current_nparams + 1);
}
...
{
    return (xcb_randr_provider_t *) (&R->pad1 + 1);
}
...
{
    return (xcb_randr_crtc_t *) (&R->pad0 + 1);
}
